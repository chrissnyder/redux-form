...
describe('createReduxForm', function () {
  ...
  it('should not replace existing values when initialValues changes if overwriteOnInitialValuesChange is set to false', function () {
    ...
    (0, _expect2.default)(stub.props.fields.instrument.value).toBe('guitar');
    (0, _expect2.default)(stub.props.fields.instrument.pristine).toBe(false);
    ...
    (0, _expect2.default)(stub.props.fields.lastName.pristine).toBe(true);
    (0, _expect2.default)(stub.props.fields.instrument.value).toBe('');
    (0, _expect2.default)(stub.props.fields.instrument.pristine).toBe(true);
  });
